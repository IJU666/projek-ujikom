        ...
        <div class="rounded-3 col-lg-10 mx-auto mt-5 pt-5 pb-3 shadow shadow-3" style="background-color: #F5F5F5;">
            <div class="form-floating col-lg-10 mx-auto mb-3">
                ...
                <div class="form-floating col-lg-6 mt-3">
                    <textarea class="form-control" name="alamat" placeholder="Leave a comment here" id="floatingTextarea" style="height: 200px;" required></textarea>
                  ...
                  <div class="mt-3 col-lg-6">
                    ...
                    <input type="text" class="form-control mt-2" name="kirim" id="asalpelapor" placeholder="Masukan kota asal pelapor">
                  </div>
                </div>
